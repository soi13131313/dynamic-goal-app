      ...
      {loading && (
        <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-md flex items-center justify-center z-50">
          <div className="bg-white px-8 py-5 rounded-2xl shadow-2xl border border-slate-100 flex flex-col items-center gap-3">
            ...
            <p className="text-sm font-black text-indigo-900 m-0 tracking-wide animate-pulse">最先端AIが目標を分析中...</p>
          </div>
        </div>
      )}

      <nav className="bg-white border-b border-slate-200 w-full px-4 sm:px-6 py-4 sticky top-0 z-50 shadow-sm shadow-slate-100">
        <div className="w-full max-w-4xl mx-auto flex justify-between items-center relative">
          ...
          <button
            ...
            className="flex items-center justify-center w-14 h-14 rounded-2xl bg-slate-900 text-white border-none cursor-pointer shadow-lg shadow-slate-900/15 hover:bg-slate-800 active:scale-[0.98] transition-all"
            aria-label="メニューを開く"
          >
          ...
          {isMenuOpen && (
            <div className="absolute top-16 right-0 w-56 bg-white border border-slate-100 rounded-2xl shadow-xl py-2 flex flex-col z-40">
              {hasGoal && (
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="text-left text-sm font-bold px-4 py-3 text-slate-600 hover:bg-slate-50 border-none bg-transparent cursor-pointer"
                >
              ...
              <button
                ...
                className="text-left text-sm font-bold px-4 py-3 text-amber-600 hover:bg-amber-50 border-none bg-transparent cursor-pointer"
              >
                🔄 完全リセット
              </button>
              ...
              <button
                ...
                className="text-left text-sm font-bold px-4 py-3 text-rose-600 hover:bg-rose-50 border-none bg-transparent cursor-pointer"
              >
                ログアウト
              </button>
            </div>
